...
## Как взять задачу из раздела projects

- Выбираем задачу из столбца **Бэклог**
- Нажимаем на нее, справа будет поле **Assignees** там выбираем себя
- Перетаскиваем из **Бэклога** в **В разработке**
- Пишем об этом в чате в дискорде
- Выполняем задачу, создаем PR в ветку <code>dev</code>
- После этого я дам свои комментарии и если все ОК, то смерджу вашу ветку в ветку <code>dev</code>

    ...
    <Layout>
      ...
      <div className={s.about__content_top}>
        <div className={s.about__desc}>
          <p className={s.about__text}>
            Платформа Личный кабинет «Репетитор» дает возможность легко взаимодействовать между преподавателем и
            учеником.
          </p>
          <p className={s.about__text}>
            Как органайзер - где можно держать всю информацию об учениках/преподавателях, расписании, свои заметки,
            материалы по урокам и все это в одном месте!
          </p>
          <p className={s.about__text}>
            А также невероятная возможность для преподавателей — теперь можно вносить и отслеживать информацию об
            ученике, который не имеет возможности пользоваться сайтом.
          </p>
        </div>
      ...
      <ul className={s.ability__list}>
        <li className={s.abilityItem}>
          <h3 className={s.abilityItem__title}>С легкостью составлять расписание</h3>
          <picture>
            <source srcSet={firstImage819px} media='(max-width: 1100px)' />
            <img className={s.abilityItem__image} src={firstImage} alt='Составить расписание' />
          </picture>
        </li>
        <li className={s.abilityItem}>
          ...
          <picture>
            ...
            <img className={s.abilityItem__image} src={secondImage} alt='Составить расписание' />
          </picture>
        </li>
        <li className={s.abilityItem}>
          ...
          <picture>
            ...
            <img className={s.abilityItem__image} src={thirdImage} alt='Составить расписание' />
          </picture>
        </li>
        <li className={s.abilityItem}>
          ...
          <picture>
            ...
            <img className={s.abilityItem__image} src={fourthImage} alt='Составить расписание' />
          </picture>
        </li>
      </ul>
      <footer className={s.about__footer}>
        <p className={s.footer__desc}>
          Присоединяйтесь к платформе Личный кабинет «Репетитор» и&nbsp;упростите&nbsp;себе рутину записей по урокам!
        </p>
        <Link to='/register'>
          <Button variant={btnClass.primary} type={btnType.button}>
            Зарегистрироваться

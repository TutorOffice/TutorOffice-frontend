...
import image405 from '../../assets/images/405.png';
...
export const errorTypes = [
    ...
    },
    {
        ...
        description: 'Чтобы иметь доступ к данной странице, зайдите в свой аккаунт или зарегистрируйтесь.',
        imageUrl: image401,
    },
    {
        id: 3,
    ...
    },
    {
        ...
        description: 'Обновите страницу или убедитесь в правильности вводимого URL-адреса',
        imageUrl: image404,
    },
    {
        id: 5,
        ...
        description: 'Проверьте правильность введённого адреса или перезагрузите страницу.',
        imageUrl: image405,
    },
]